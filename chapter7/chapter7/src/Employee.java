 ...
 * of "No name" indicates no real name specified yet. A hire date of January 1,
 * 1000 indicates no real hire date specified yet.
 *
 * @see Date.java
 */
public class Employee {
    ...
    private String name;
    private Date hireDate; // The class Date is defined in Display 4.13.
